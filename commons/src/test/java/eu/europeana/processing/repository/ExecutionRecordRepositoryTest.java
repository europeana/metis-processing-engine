...
class ExecutionRecordRepositoryTest extends RepositoryTest {
  ...
  @Test
  void shouldCorrectlySaveOneExecutionRecordToDB() throws FlinkWorkflowException {
  ...
  @Test
  void shouldCorrectlySaveTwoExecutionRecordsToDB() throws FlinkWorkflowException {
    ExecutionRecordRepository executionRecordRepository = prepareRepository();
  ...
  @Test
  void shouldCorrectlySaveTwoExecutionRecordsFromOneExecutionToDB() throws FlinkWorkflowException {
    ExecutionRecordRepository executionRecordRepository = prepareRepository();
  ...
  @Test
  void shouldCountByDatasetIdAndExecutionId() throws FlinkWorkflowException {
    ExecutionRecordRepository executionRecordRepository = prepareRepository();
  ...
  @Test
  void shouldRetrieveRecordsFromDB() throws FlinkWorkflowException {
    ExecutionRecordRepository executionRecordRepository = prepareRepository();
