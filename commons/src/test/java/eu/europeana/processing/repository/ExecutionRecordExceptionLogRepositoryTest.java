...
class ExecutionRecordExceptionLogRepositoryTest extends RepositoryTest {
  ...
  @Test
  void shouldSaveCorrectExecutionRecordExceptionLog() {
  ...
  @Test
  void shouldCountByDatasetIdAndExecutionId_1() throws IOException {
    ExecutionRecordExceptionLogRepository executionRecordExceptionLogRepository = prepareRepository();
  ...
  @Test
  void shouldCountByDatasetIdAndExecutionId_2() throws IOException {
    ExecutionRecordExceptionLogRepository executionRecordExceptionLogRepository = prepareRepository();
